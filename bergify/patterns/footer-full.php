...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group" style="padding-top:50px;padding-bottom:50px;padding-left:20px;padding-right:20px">
		...
		<div class="wp-block-columns"><!-- wp:column {"width":"33.3%","style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"0px","left":"0px"}}}} -->
			...
			<!-- wp:paragraph -->
			<p><?php esc_html_e( 'UI Kits, Templates and Dashboards built on top of Tailwind, Vue.js, React, Angular, Node.js and Laravel. Join over 516,257 creatives to access all our products!', 'bergify' ); ?></p>
			<!-- /wp:paragraph -->
			
			<!-- wp:social-links {"iconColor":"quaternary","iconColorValue":"#F9FAFB","className":"is-style-logos-only"} -->
			...
			<h3 class="has-white-color has-text-color has-normal-font-size" id="company"><strong><?php esc_html_e( 'COMPANY', 'bergify' ); ?></strong></h3>
			<!-- /wp:heading -->
			...
			<!-- wp:column {"width":"16.6%"} -->
			<div class="wp-block-column" style="flex-basis:16.6%"><!-- wp:heading {"level":3,"textColor":"white","fontSize":"normal"} -->
			<h3 class="has-white-color has-text-color has-normal-font-size" id="help-and-support"><strong><?php esc_html_e( 'HELP AND SUPPORT', 'bergify' ); ?></strong></h3>
			<!-- /wp:heading -->
			...
			<!-- wp:column {"width":"16.6%"} -->
			<div class="wp-block-column" style="flex-basis:16.6%"><!-- wp:heading {"level":3,"textColor":"white","fontSize":"normal"} -->
			<h3 class="has-white-color has-text-color has-normal-font-size" id="resources"><strong><?php esc_html_e( 'RESOURCES', 'bergify' ); ?></strong></h3>
			<!-- /wp:heading -->
			...
			<!-- wp:column {"width":"16.6%"} -->
			<div class="wp-block-column" style="flex-basis:16.6%"><!-- wp:heading {"level":3,"textColor":"white","fontSize":"normal"} -->
			<h3 class="has-white-color has-text-color has-normal-font-size" id="legal"><strong><?php esc_html_e( 'LEGAL', 'bergify' ); ?></strong></h3>
			<!-- /wp:heading -->
		...
		<!-- wp:separator {"align":"wide","style":{"color":{"text":"#374151"}},"className":"is-style-wide"} -->
		<hr class="wp-block-separator alignwide has-text-color is-style-wide" style="color:#374151" />
		<!-- /wp:separator -->
